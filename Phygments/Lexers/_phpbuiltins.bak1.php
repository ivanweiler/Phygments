...
if(php_sapi_name() == 'cli') {
	...
	{	
		...
		//copy($PHP_MANUAL_URL,'./somefile.zip');
		
		/*
		$p = new PharData('./somefile.tar.gz');
		$p->decompress();
		$phar = new PharData('./somefile.tar');
		$phar->extractTo('./');	//php-chunked-xhtml
		*/
	...
	{	
		...
		//echo sprintf('$MODULES = %s', var_export($modules, true));
