...
class Php extends Regex
{
    ...
    protected $flags = [re::IGNORECASE, re::DOTALL, re::MULTILINE];
	    ...
	    return [
			...
			'string' => [
				...
				['\\$[a-zA-Z_][a-zA-Z0-9_]*(\\[\\S+\\]|->[a-zA-Z_][a-zA-Z0-9_]*)?',
					'String.Interpol'],
				['(\\{\\$\\{)(.*?)(\\}\\})',
					$this->_bygroups('String.Interpol', $this->_using($this, array('_startinline'=>true)), 'String.Interpol')],
				['(\\{)(\\$.*?)(\\})',
					$this->_bygroups('String.Interpol', $this->_using($this, array('_startinline'=>true)), 'String.Interpol')],
				['(\\$\\{)(\\S+)(\\})',
	...
	{
		$this->funcnamehighlighting = Util::get_bool_opt($options, 'funcnamehighlighting', true);
		$this->disabledmodules = Util::get_list_opt($options, 'disabledmodules', ['unknown']);
